...
LOOP3
		...
		;NOPS TO COVER FOR STATUS CLEARS IN BEGINING. CAN BE USED TO DIAL IN TIME.
		MOVLW H'30'
		MOVWF PORTB	
		MOVWF TMR2                           ;FIND
		MOVLW H'F4'                          ; REDUCED FROM 'F4' TO CURRENT
		MOVWF TMR2                           ;FIND REGISTER FOR COUNTING
LOOP21
		CLRF  TMR0                              ;FIND INNER REGISTER FOR COUNTING
LOOP11
		NOP
		NOP
		NOP
