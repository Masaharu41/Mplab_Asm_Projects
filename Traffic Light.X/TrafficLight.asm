...
TMRSTART
	...
	;CLRF TMR2
	CLRF COMPARECNT
	MOVLW H'ED'         ; SET OVERFLOW COMPARE GPR COMPLEMENT OF FINAL COUNT PLUS ONE WAS D3
	MOVWF COMPARECNT
;	MOVLW H'78'
;	MOVWF T2CON
	MOVLW H'20'	    ; SET PRESCALE TO 1:4
	MOVWF T1CON
	BANKSEL PIE1
...
TMRYELLOW
	CLRF COMPARECNT
	MOVLW H'FC'         ; SET OVERFLOW COMPARE GPR COMPLEMENT OF FINAL COUNT PLUS ONE WAS FC
	MOVWF COMPARECNT
	RETURN

TMRGREEN
	CLRF COMPARECNT
	MOVLW H'ED'        ; SET OVERFLOW COMPARE GPR COMPLEMENT OF FINAL COUNT PLUS ONE WAS ED FOR TMR1
	MOVWF COMPARECNT
	RETURN
