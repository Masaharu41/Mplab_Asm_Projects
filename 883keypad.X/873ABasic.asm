...
;*** SET OPTION_REG: ****
		BANKSEL OPTION_REG
		MOVLW H'D0'                             ; INITIALIZE SET OF RBPU INTEDG T0SE 
		MOVWF OPTION_REG
;*** SET INTCON REG: ****
		BANKSEL INTCON
		MOVLW H'40'
...
MAIN	
		...
		MOVLW H'30'                              ; MOVE LITERAL 'O' FOR DISPLAY IN HEX TO W
		MOVWF PORTC                              ; MOVE W TO PORTC WITH 0 ADDRESS BIT 
		CLRW	                                 ; CLEAR W
		GOTO RUN
RUN 
		
		BANKSEL PORTB                            ; BEGIN ACTIVE CHECK OF PORT B
		BTFSC PORTB,RB0				 ; BIT CHECK RB0 IF CLEARED NEXT INSTRUCTION SKIPPED
		GOTO SET0                                ; IF RB0 IS SET THEN GO TO NEXT COMMAND
		BTFSC PORTB,RB1				 ; ALL OTHER INPUTS ARE CHECKED THE SAME AS RB0
		GOTO SET1 				 
		BTFSC PORTB,RB2
		GOTO SET2
		BTFSC PORTB,RB3
...
SET0		
		MOVLW H'30'                         ; SET WORKING REGISTRY TO OUTPUT HEX
		BANKSEL PORTC			    ; INITILIZE PORTC
		MOVWF PORTC                         ; MOVE W INTO PORTC
		CLRW                                ; CLEAR W
		GOTO RUN		            ; GO BACK TO RUN CODE
		
		
SET1		
		MOVLW H'31' 			    ; refer to set0
		BANKSEL PORTC
		MOVWF PORTC 
		CLRW
		GOTO RUN
SET2		
		MOVLW H'32'                         ; refer to set0
		BANKSEL PORTC
		MOVWF PORTC 
		CLRW
		GOTO RUN
SET3		
		MOVLW H'33'                         ; refer to set0
		BANKSEL PORTC
		MOVWF PORTC 
		CLRW
		GOTO RUN
SET4		
		MOVLW H'34'                         ; refer to set0
		BANKSEL PORTC
		MOVWF PORTC 
		CLRW
		GOTO RUN
SET5		
		MOVLW H'35'                         ; refer to set0
		BANKSEL PORTC
		MOVWF PORTC 
		CLRW
		GOTO RUN
SET6	
		MOVLW H'36'                         ; refer to set0
		BANKSEL PORTC
		MOVWF PORTC 
		CLRW
		GOTO RUN
SET7		
		MOVLW H'37'                         ; refer to set0
		BANKSEL PORTC
		MOVWF PORTC 
		CLRW
		GOTO RUN
